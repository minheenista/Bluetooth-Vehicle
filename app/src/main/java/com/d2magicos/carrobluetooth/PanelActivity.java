...
public class PanelActivity extends AppCompatActivity {
    ...
    private ImageView imgUp, imgDown, imgLight, imgLeft, imgRight, imgStop, imgConnect, imgIntermitentes, imgBajas;
    ...
    final static String INTERMITENTES="I";
    final static String BAJAS="U";
    ...
    private void inicializarControles() {
        ...
        imgIntermitentes = findViewById(R.id.img_intermitentes);
        imgBajas = findViewById(R.id.img_lights_bajas);
        ...
        imgIntermitentes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(myBluetoothSerialService != null && myBluetoothSerialService.getState() == MyBluetoothSerialService.STATE_CONNECTED){
                    myBluetoothSerialService.serialWriteString(INTERMITENTES); // Enviamos la data a nuestro arduino
                }else{
                    Config.Mensaje(PanelActivity.this, "Debe conectar su bluetooth", false, false);
                }
            }
        ...
        imgBajas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(myBluetoothSerialService != null && myBluetoothSerialService.getState() == MyBluetoothSerialService.STATE_CONNECTED){
                    myBluetoothSerialService.serialWriteString(BAJAS); // Enviamos la data a nuestro arduino
                }else{
                    Config.Mensaje(PanelActivity.this, "Debe conectar su bluetooth", false, false);
                }
            }
